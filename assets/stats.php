...
<?php
    ...
    // get values from donut.txt for donut chart
    ...
    $slist = "[" . $sure_food . ", " . $unsure . ", " . $sure_not_food . "]";
    ...
    ////////////////////////////////////////////////////////////////
    // This code is used to validate and upload image files
    if(isset($_POST["submit"])) {
        ...
        if ($uploadOk == 1){
            ...
            foreach($_FILES['uploads']['tmp_name'] as $key => $tmp_name){
                ...
                $url = "uploads/" . date('Y-m-d.h:i:sa') . $filename;
                rename("uploads/" . $filename, $url);
...
<footer class="py-5 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">CS 4110 &nbsp;&bull;&nbsp; Intro to Software Engineering</p>
    </div>
    <!-- /.container -->
</footer>
